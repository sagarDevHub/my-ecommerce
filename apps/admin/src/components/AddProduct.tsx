                              ...
                              {field.value.map(color => (
                                <div className="flex items-center gap-2" key={color}>
                                  ...
                                  <input
                                    type="file"
                                    accept="image/*"
                                    className="w-full text-sm text-gray-400 bg-transparent border border-gray-800 rounded-lg p-2.5 file:bg-transparent file:border-0 file:text-sm file:font-medium file:text-white file:mr-4 cursor-pointer"
                                  />
                                </div>
                              ))}
                            </div>
