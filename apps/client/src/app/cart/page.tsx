...
const CartPage = () => {
  ...
  const activeStep = parseInt(serachParams.get('step') || '1');
    ...
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        {steps.map(step => (
          ...
          >
            <div
              className={`flex items-center justify-center text-white w-6 h-6 rounded-full ${step.id === activeStep ? 'bg-gray-800' : 'bg-gray-400'}`}
            >
              {step.id}
            </div>
            <p
        ...
        <div className="w-full lg:w-5/12 shadow-lg border border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max">
          ...
          {activeStep === 1 && (
            <button
              ...
              className="w-full bg-gray-800 hover:bg-gray-900 transition-all text-white duration-300 p-2 rounded-lg cursor-pointer flex items-center justify-center gap-2"
            >
              Continue
